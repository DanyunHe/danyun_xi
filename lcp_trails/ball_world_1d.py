...
class BallWorld(object):
	...
	def __init__(self,x1=30,y1=30,x2=70,y2=70,x3=150,y3=50,x4=150, y4=150,\
		speed_x1=1000,speed_y1=0,speed_x2=-1000,speed_y2=0,speed_x3=300,speed_y3=-1000,speed_x4=1000, speed_y4=1000,\
		...
		self.balls.append(Ball(x1, speed_x1, 10, Color('yellow'), 'yellow', self.verbose))
...
if __name__=="__main__":
	...
	bw = BallWorld(x1=30.1,y1=30.2,x2=70.1,y2=70.2,x3=250.1,y3=100.2, x4=150, y4=150,\
		speed_x1=500,speed_y1=300,speed_x2=-500,speed_y2=1,speed_x3=300,speed_y3=-1000, speed_x4=1000, speed_y4=1000,\
		left=0, top=0, width=600, height=100, verbose = 0)

	params=bw.run(1,20000,0.01) # generate data 
	if verbose:
		print(params[0])
